...
namespace BonusService.Migrations
{
    ...
    [Migration("20231118221923_AddProgramms")]
    partial class AddProgramms
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BonusService.Postgres.BonusProgramHistory", b =>
                {
                    ...
                    b.Property<BonusProgramHistoryInfo>("Info")
                        .IsRequired()
                        .HasColumnType("jsonb");
